...
/* Offline Transaction */
TRANS_gasprice              : 'Gas价格 ',
TRANS_gasnonce              : 'Nonce',
OFFLINE_Title               : '生成、发送离线交易',
OFFLINE_1_Title             : 'Get Account Info (联网电脑）',
OFFLINE_1_Button            : 'Get Info',
OFFLINE_1_Label_1           : 'Sending Address',
OFFLINE_1_Help_1            : '注意：这是发自地址，不是发往地址。',
OFFLINE_2_Title             : 'Generate Transaction (离线电脑 or 联网电脑)',
OFFLINE_3_Title             : 'Sign Transaction (离线电脑)',
...
OFFLINE_2_Help_2            : '21000是默认的gas限制. Tokens use 150000+. Complex contracts may need more. You shouldn\'t ever need to go over 500000',
...
OFFLINE_4_Title             : 'Broadcast Transaction (联网电脑）',
