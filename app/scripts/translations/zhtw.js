...
/* Offline Transaction */
TRANS_gasprice              : '每單位gas的費用',
TRANS_gasnonce              : 'Nonce',
OFFLINE_Title               : 'Generate / Sign / Broadcast Transactions',
OFFLINE_1_Title             : 'Get Account Info (在連網裝置上）',
OFFLINE_1_Button            : 'Get Info',
OFFLINE_1_Label_1           : '交易發起方的地址',
OFFLINE_1_Help_1            : '注意： 這是交易發起方的地址，不是交易接受方的地址。',
OFFLINE_2_Title             : 'Generate Transaction (Offline or Online)',
OFFLINE_3_Title             : 'Sign Transaction（在離線裝置上）',
...
OFFLINE_2_Help_2            : '21000 是預設的gas總量（單純轉錢）。 Tokens use 150000+. Complex contracts may need more. You shouldn\'t ever need to go over 500000',
...
OFFLINE_4_Title             : 'Broadcast Transaction (在連網裝置上）',
